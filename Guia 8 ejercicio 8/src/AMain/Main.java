...
planear sus vacaciones de acuerdo a sus posibilidades. 

Los alojamientos se identifican por un nombre, una dirección, una localidad y un gerente encargado
del lugar. La compañía trabaja con dos tipos de alojamientos: 
...
Por cada Alojamiento Extrahotelero se indica si es privado o no, así
...
Realizar un programa en el que se representen
...
import Servicios.ServicioCrear;

public class Main {

    public static void main(String[] args) {
        ServicioCrear serv = new ServicioCrear();
