...
y lo que interesa conocer es la superficie que tiene y los tipos de polideportivos.

Un edificio de oficinas es un edificio; interesa conocer la superficie que tiene.
...
Luego crearemos una clase Polideportivo con sus atributos
largo, ancho, nombre y tipo de instalación que puede ser Techado o Abierto, esta
clase implementará las dos interfaces. 

Además, vamos a crear una clase
...
icioDeOficinas con sus atributos número de oficinas, ancho, largo y numero
de pisos. Esta clase solo implementará la interfaz Edificio.
