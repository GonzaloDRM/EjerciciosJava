...
public class AMain {
    ...
    public static void main(String[] args) {
        ...
        ServicioAsignaciones ser = new ServicioAsignaciones();
        ServiciosCompletar comp = new ServiciosCompletar();
        int resp;
        
        do{
            System.out.println("Seleccione la opcion que desee");
            System.out.println("1 - Hacer todo automatico");
            System.out.println("2 - Hacer todo manual");
            System.out.println("3 - Salir");
            resp = sc.nextInt();
            switch(resp){
                case 1: comp.automatico();
                    break;
                case 2: ser.manual();
                    break;
                case 3: break;    
