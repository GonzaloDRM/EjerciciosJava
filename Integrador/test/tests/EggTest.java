...
public class EggTest {
    ...
    public void numeroCapicuaTest() {
        assertEquals(true, pr.numeroCapicua(123454321L));
        assertEquals(true, pr.numeroCapicua(-123454321L));
        assertEquals(true, pr.numeroCapicua(2L));
        assertEquals(true, pr.numeroCapicua(0L));
        assertEquals(false, pr.numeroCapicua(231L));
        assertEquals(false, pr.numeroCapicua(123L));
        assertEquals(false, pr.numeroCapicua(Long.MAX_VALUE));
    }
}
