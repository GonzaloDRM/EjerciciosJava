...
public class Libro {
    ...
    public String toString() {
        return "Libro{" + "nombre = " + nombre + ", autor = " + autor + ", ejemplaresDisponibles = " + ejemplaresDisponibles + ", ejemplaresPrestados = " + ejemplaresPrestados + ", ejemplaresTotales = " + ejemplaresTotales + '}';
    }
