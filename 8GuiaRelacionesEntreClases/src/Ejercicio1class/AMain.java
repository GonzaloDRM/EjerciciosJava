/*
 posición actual (posición del
tambor donde se dispara, puede que esté la bala o no) y
posición bala (la posición del
...
public class AMain {
    ...
    public static void main(String[] args) {
        JuegoServicio game = new JuegoServicio();
        Juego g = new Juego();
        
        game.LlenarJuego(g);
        game.Ronda(g.getJugador());
